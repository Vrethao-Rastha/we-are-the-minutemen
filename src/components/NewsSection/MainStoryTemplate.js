  ...
  <div>
    ...
    <Col>
      <Card className="mainCard">
        <CardTitle style={{marginTop:".5em"}}  className="text-center" style={{fontSize:"30pt"}}>{ this.props.main[0].title }</CardTitle>
         <CardImg className="headline cardImg" top width="100%" src={ process.env.PUBLIC_URL + this.props.main[0].picture} alt="Card image cap" />
            <CardBody>
